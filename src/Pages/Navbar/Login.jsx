...
<div className="card shadow-2xl w-full bg-base-100">
  ...
  <form className="card-body">
    ...
    <div className="form-control mt-6">
    <p className="text-left font-raleway text-xs md:text-lg font-bold text-black">Do You Have An Account? Please <Link to={'/login'} className="text-green-500">Register</Link></p>
    </div>
  </form>
